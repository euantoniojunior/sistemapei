...
def criar_pei():
    try:
        ...
        # Se for edição, atualiza o aluno existente
...
# ✅ Rota: Buscar alunos por nome (usada na search.html)
...
# ✅ Rota: Listar histórico de alterações
...
def gerar_pdf():
    ...
    try:
        ...
        return jsonify({"error": "Erro ao gerar PDF", "detalhe": str(e)}), 500
